...
\item We houden de harddisk indeling simpel, dus kiezen we \textquote{Guided - Use entire disk} als onze optie voor de harddisk indeling zoals aangegeven in \ref{DebDiskPart}.
...
\item daarna kiezen voor All files in one partition.
...
\item Debian gaat nu opzoek naar updates en additionele software die ge\"installeerd kan worden. De repo's van Debian staan over de wereld verspreid, om geen data op te halen van bijvoorbeeld servers in de Verenigde Staten, maar alleen van servers in Nederland moeten we een keuze maken vanaf welke servers wij onze software willen ophalen. Kies Netherlands.

\item Selecteer daarna deb.debian.org.

\item We gebruiken geen proxy dus bij die vraag mag je continue geven.
