$ cd ~
$ mkdir ZIB
$ echo "Een commando op Unix" > ZIB/KleineCommandos.txt
$ echo "systemen is vaak klein" >> ZIB/kleineCommandos.txt
$ echo "en simpel en doet 1" >> ZIB/kleineCommandos.txt
$ echo " ding goed." >> ZIB/kleineCommandos.txt
